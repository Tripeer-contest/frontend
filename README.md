...
- [프로젝트 개요](#프로젝트-개요)
  - [서비스 개발 배경](#서비스-개발-배경)
  - [서비스 설명](#서비스-설명)
  - [프로젝트 Version 1 둘러보기](#프로젝트-version-1-둘러보기)
- [주요 변경 사항](#주요-변경-사항)
  - [1. 사용자 피드백 반영](#1-사용자-피드백-반영)
    - [(1) 모바일 버전 추가 및 반응형 웹 구현](#1-모바일-버전-추가-및-반응형-웹-구현)
    - [(2) 여행지 정보 확장](#2-여행지-정보-확장)
    - [(3) 알림 기능 개선](#3-알림-기능-개선)
    - [(4) 사진 앨범 기능 조정](#4-사진-앨범-기능-조정)
  - [2. 코드 구조 및 성능 최적화](#2-코드-구조-및-성능-최적화)
    - [(1) TypeScript 도입](#1-typescript-도입)
    - [(2) Next.js에서 React로 전환](#2-nextjs에서-react로-전환)
    - [(3) Tanstack Query 도입](#3-tanstack-query-도입)
    - [(4) 코드 리뷰 강화](#4-코드-리뷰-강화)
- [주요 기능](#주요-기능)
- [프로젝트 구조](#프로젝트-구조)
- [기술 스택](#기술-스택)
- [서비스 화면](#서비스-화면)
